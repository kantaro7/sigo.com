...
<div id="actual_contenedor">
  ...
  <div>
    <form id="frm_actual" name="frm_actual" method="post" action="<?php echo("admin/pages/".$_SESSION["carpeta"]."/".$_SESSION["rprog"]."_actual_db.php"); ?>" onsubmit="return frm_vldt_<?php echo($_SESSION["rprog"]."('$accn');"); ?>" enctype="multipart/form-data" accept-charset="UTF-8">
        ...
        <div id="elmnt_case">
        	<input type="text" name="nombre" id="nombre" class="elmnt_elmnt" size="70" maxlength="150" placeholder="<?php echo(html_encode("Indique el nombre")); ?>" value="<?php echo(html_encode($reg_data["nombre"])); ?>" tabindex="01" onKeyPress="if(event.keyCode==13){ document.getElementById('titulo').focus(); } return frmt_alpha(event);" >
        </div>
			</div>
			<div id="elmnt_block">
        <div id="elmnt_image"><img id="img_mat_right" src="admin/images/mat_icons/title_36.png" width="30" height="30" style=" float: left; margin-top: 3px; margin-left: 3px;" /></div>
        <div id="elmnt_title"><?php echo(html_encode("Título")); ?></div>
        <div id="elmnt_case">
        	<input type="text" name="titulo" id="titulo" class="elmnt_elmnt" size="70" maxlength="150" placeholder="<?php echo(html_encode("Indique el título")); ?>" value="<?php echo(html_encode($reg_data["titulo"])); ?>" tabindex="01" onKeyPress="if(event.keyCode==13){ document.getElementById('texto').focus(); } return frmt_alpha(event);" >
        </div>
			</div>
			<div id="elmnt_block">
        ...
        <div id="elmnt_title"><?php echo(html_encode("Imagen Principal")); ?></div>
        <div id="elmnt_case_sl">
          <div class="elmnt_foto"><input type="file" name="img_foto_1" id="img_foto_1" class="elmnt_file" size="2" maxlength="150" style="float: left;" ></div>
      		<div class="msg_image"><?php echo(html_encode("(Dimensiones: 700 x 460 pixeles. Peso no mayor de 300 Kb. Tipo JPG o PNG.)")); ?></div>
        </div>
        <div id="elmnt_title"><?php echo(html_encode("Imagen para Móvil")); ?></div>
        <div id="elmnt_case_sl">
          <div class="elmnt_foto"><input type="file" name="img_foto_2" id="img_foto_2" class="elmnt_file" size="2" maxlength="150" style="float: left;" ></div>
      		<div class="msg_image"><?php echo(html_encode("(Dimensiones: 360 x 240 pixeles. Peso no mayor de 200 Kb. Tipo JPG o PNG.)")); ?></div>
        </div>
			</div>
