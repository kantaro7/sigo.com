...
if($reg_tot>0){
  ...
  <div id="data_header">
    <table width="100%" align="center" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="55%" align="left"	 valign="middle"><b><?php echo(html_encode("Texto")); ?></b></td>
  ...
  <div id="data_body">
    ...
    <tr style="background-color: <?php echo($color); ?>;">
      ...
      <td width="20%" align="left"	 valign="middle"><img src="<?php echo($im_pth); ?>" width="210" height="60" alt="img" style="" /></td>
      <td width="55%" align="left"	 valign="middle"><?php echo(html_encode($main_data["texto"])); ?></td>
