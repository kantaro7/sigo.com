...
if($ok_ssn){
	...
	$_SESSION["carpeta"]		="sec_8_secure";
	$_SESSION["rprog"]			="sc_users";
	$_SESSION["modulo"]			="8";
	$_SESSION["opcion"]			="1";
	
	$_SESSION["tabla"]			="sc_users";
	$_SESSION["elemento"]		="sc_users";
	$_SESSION["titulo"]			="Usuario";
	$_SESSION["titulos"]		="Usuarios";
	$_SESSION["letra_final"]="o";

	//Obtener el número de página a mostrar de la colección $_GET
	if(!isset($_SESSION["row_pag"])) $_SESSION["row_pag"]=15;
	if(!isset($_SESSION["num_pag"])) $_SESSION["num_pag"]=1;

	//Inicializar Información de Criterios de Búsqueda
	$_SESSION["crt_bsq"]="";
	$_SESSION["crt_tit"]="";
	$_SESSION["crt_ord"]="user_name";
	?>
  <style type="text/css">
		#gran_contenedor {
			width: 100%;
