...
$_POST["titulo"]=htmlentities($_POST['titulo'], ENT_QUOTES, "UTF-8");
...
if($_FILES['img_foto_1']['name']!="") vrfy_upld_fl("img_foto_1", "Foto", $accn, 307200);
if($_FILES['img_foto_2']['name']!="") vrfy_upld_fl("img_foto_2", "Foto", $accn, 204800);
...
if($msg!=""){
	...
	switch ($accn) {
		case "i":
			...
			$sql="INSERT INTO ".$_SESSION["tabla"]." (nombre, titulo, texto, name_foto_1, name_foto_2, shown) VALUES ('".$_POST["nombre"]."', '".$_POST["titulo"]."', '".$_POST["texto"]."', '".$_FILES['img_foto_1']['name']."', '".$_FILES['img_foto_2']['name']."', '$act_chk')";
			//echo("sql [".$sql."] <br>");
			...
			if($status===false){
				...
				$rslt_3 = upld_image("img_foto_1", "Foto 1", $id_lcl, "ft_1");
				$rslt_3 = upld_image("img_foto_2", "Foto 2", $id_lcl, "ft_2");
			}
			break;
		case "m":
			...
			$sql="UPDATE ".$_SESSION["tabla"]."  SET nombre='".$_POST["nombre"]."', titulo='".$_POST["titulo"]."', texto='".$_POST["texto"]."', shown='$act_chk'  $str_img  WHERE id_".$_SESSION["tabla"]."=$clave";
			//echo("sql [".$sql."] <br>");
			$stmt1=$db_pdo->prepare($sql);
			if($stmt1===false){
				trigger_error($db_pdo->error, E_USER_ERROR);
			...
			if($status===false){
				...
				if($_FILES['img_foto_1']['name']!="") $rslt_3 = upld_image("img_foto_1", "Foto 1", $clave, "ft_1");
				if($_FILES['img_foto_2']['name']!="") $rslt_3 = upld_image("img_foto_2", "Foto 2", $clave, "ft_2");
			}
			break;
		case "e":
			//Modificar (vía PDO) la tabla correspondiente
