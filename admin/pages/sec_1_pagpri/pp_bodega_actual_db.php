...
vrfy_upld_fl("img_foto", "Foto", $accn, 409600);
...
if($msg!=""){
	...
	switch ($accn) {
		case "i":
			...
			$sql="INSERT INTO ".$_SESSION["tabla"]." (nombre, titulo, texto, name_foto, shown) VALUES ('".$_POST["nombre"]."', '".$_POST["titulo"]."', '".$_POST["texto"]."', '".$_FILES['img_foto']['name']."', '$act_chk')";
			//echo("sql [".$sql."] <br>");
