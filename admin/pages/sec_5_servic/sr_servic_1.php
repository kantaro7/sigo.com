...
if($ok_ssn){
	...
	$_SESSION["rprog"]			="sr_servic_1";
	$_SESSION["rimag"]			="sr_servic_1";
	$_SESSION["modulo"]			="5";
	$_SESSION["opcion"]			="2";
	
	$_SESSION["tabla"]			="sr_servic_1";
	$_SESSION["elemento"]		="sr_servic_1";
	$_SESSION["titulo"]			="Contenido de Servicio 1";
	$_SESSION["titulos"]		="Contenidos de Servicio 1";
