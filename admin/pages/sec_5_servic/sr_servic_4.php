...
if($ok_ssn){
	...
	$_SESSION["rprog"]			="sr_servic_4";
	$_SESSION["rimag"]			="sr_servic_4";
	$_SESSION["modulo"]			="5";
	$_SESSION["opcion"]			="5";
	
	$_SESSION["tabla"]			="sr_servic_4";
	$_SESSION["elemento"]		="sr_servic_4";
	$_SESSION["titulo"]			="Contenido de Servicio 4";
	$_SESSION["titulos"]		="Contenidos de Servicio 4";
