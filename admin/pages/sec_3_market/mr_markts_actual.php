...
$ori_ico="check_un1_36.png";
if($reg_data["orientacion"]=="$vlr_chkbx_si") $ori_ico="check1_36.png";
...
<div id="actual_contenedor">
  ...
  <div>
    <form id="frm_actual" name="frm_actual" method="post" action="<?php echo("admin/pages/".$_SESSION["carpeta"]."/".$_SESSION["rprog"]."_actual_db.php"); ?>" onsubmit="return frm_vldt_<?php echo($_SESSION["rprog"]."('$accn');"); ?>" enctype="multipart/form-data" accept-charset="UTF-8">
        ...
        <div id="elmnt_title"><?php echo(html_encode("Texto Lateral")); ?></div>
        <div id="elmnt_case">
			...
			<div id="elmnt_block">
        <div id="elmnt_image"><img id="img_mat_right" src="admin/images/mat_icons/label_36.png" width="30" height="30" style=" float: left; margin-top: 3px; margin-left: 3px;" /></div>
        <div id="elmnt_title"><?php echo(html_encode("Texto Inferior")); ?></div>
        <div id="elmnt_case">
					<textarea name="texto_2" id="texto_2" cols="58" rows="3" class="elmnt_elmnt" placeholder="<?php echo(html_encode("Indique el texto")); ?>" style="color: #444444; font-family: Calibri, Arial font-size: 18px; font-weight: 300; line-height: 22px;" onKeyPress="return frmt_alpha(event);" ><?php echo(html_encode($reg_data["texto_2"])); ?></textarea>
        </div>
			</div>
 			<div id="elmnt_block">
        ...
        <div id="elmnt_title"><?php echo(html_encode("Imagen a la Derecha?")); ?></div>
				<img id="ori_ico" class="elmnt_ic_chk" src="admin/images/mat_icons/<?php echo($ori_ico); ?>" onclick="swtch_chkbox(this.id, 'ori_chk');" alt="" width="34" height="34" />
        <input name="ori_chk" id="ori_chk" type="checkbox" value="<?php echo($vlr_chkbx_si); ?>" <?php if($reg_data["orientacion"]=="$vlr_chkbx_si") echo(" checked "); ?> style="display: none;" />
			</div>     
			<div id="elmnt_block">
        ...
        <div id="elmnt_case_sl">
          <div class="elmnt_foto"><input type="file" name="img_foto" id="img_foto" class="elmnt_file" size="2" maxlength="150" style="float: left;" ></div>
      		<div class="msg_image"><?php echo(html_encode("(Dimensiones: 700 x 340 o 500 x 400 pixeles. Peso no mayor de 400 Kb. Tipo JPG o PNG.)")); ?></div>
        </div>
			</div>
