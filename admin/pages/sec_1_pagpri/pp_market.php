...
if($ok_ssn){
	...
	$_SESSION["rprog"]			="pp_market";
	$_SESSION["rimag"]			="pp_market";
	$_SESSION["modulo"]			="1";
	$_SESSION["opcion"]			="2";
	
	$_SESSION["tabla"]			="pp_market";
	$_SESSION["elemento"]		="pp_market";
	$_SESSION["titulo"]			="Contenido de la Sección Market";
	$_SESSION["titulos"]		="Contenidos de la Sección Market";
	...
	$_SESSION["crt_bsq"]="";
	$_SESSION["crt_tit"]="";
	$_SESSION["crt_ord"]="id_pp_market DESC";
	?>
  <style type="text/css">
		#gran_contenedor {
			width: 100%;
