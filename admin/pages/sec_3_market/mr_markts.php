...
if($ok_ssn){
	...
	$_SESSION["rprog"]			="mr_markts";
	$_SESSION["rimag"]			="mr_markts";
	$_SESSION["modulo"]			="3";
	$_SESSION["opcion"]			="2";
	
	$_SESSION["tabla"]			="mr_markts";
	$_SESSION["elemento"]		="mr_markts";
	$_SESSION["titulo"]			="Tipo de Market";
	$_SESSION["titulos"]		="Tipos de Market";
