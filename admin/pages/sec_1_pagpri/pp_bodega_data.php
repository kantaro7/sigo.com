...
if($reg_tot>0){
	...
	$stmt2=$db_pdo->prepare("SELECT *  FROM ".$_SESSION["tabla"]."  WHERE deleted='$vlr_chkbx_no'  :crt_bsq  ORDER BY id_pp_bodega DESC  LIMIT $prm_lmt  OFFSET $prm_off ;");
	if($stmt2===false){
		trigger_error($db_pdo->error, E_USER_ERROR);
	}
	//Bind params
  ...
  <div id="data_body">
    ...
    <tr style="background-color: <?php echo($color); ?>;">
      ...
      <td width="15%" align="left"	 valign="middle"><img src="<?php echo($im_pth); ?>" width="160" height="80" alt="img" style="" /></td>
