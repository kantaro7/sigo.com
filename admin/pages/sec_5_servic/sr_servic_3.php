...
if($ok_ssn){
	...
	$_SESSION["carpeta"]		="sec_5_servic";
	$_SESSION["rprog"]			="sr_servic_3";
	$_SESSION["rimag"]			="sr_servic_3";
	$_SESSION["modulo"]			="5";
	$_SESSION["opcion"]			="4";
	
	$_SESSION["tabla"]			="sr_servic_3";
	$_SESSION["elemento"]		="sr_servic_3";
	$_SESSION["titulo"]			="Contenido de Servicio 3";
	$_SESSION["titulos"]		="Contenidos de Servicio 3";
