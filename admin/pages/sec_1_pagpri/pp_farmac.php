...
if($ok_ssn){
	...
	$_SESSION["carpeta"]		="sec_1_pagpri";
	$_SESSION["rprog"]			="pp_farmac";
	$_SESSION["rimag"]			="pp_farmac";
	$_SESSION["modulo"]			="1";
	$_SESSION["opcion"]			="4";
	
	$_SESSION["tabla"]			="pp_farmac";
	$_SESSION["elemento"]		="pp_farmac";
	$_SESSION["titulo"]			="Contenido de la Sección Farmacia";
	$_SESSION["titulos"]		="Contenidos de la Sección Farmacia";
	...
	$_SESSION["crt_bsq"]="";
	$_SESSION["crt_tit"]="";
	$_SESSION["crt_ord"]="id_pp_farmac DESC";
	?>
  <style type="text/css">
		#gran_contenedor {
			width: 100%;
