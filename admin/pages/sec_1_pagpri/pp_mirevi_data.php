...
$stmt1=$db_pdo->prepare("SELECT *  FROM ".$_SESSION["tabla"]."  WHERE deleted='$vlr_chkbx_no'  :crt_bsq");
if($stmt1===false){
...
if($reg_tot>0){
	...
	$stmt2=$db_pdo->prepare("SELECT *  FROM ".$_SESSION["tabla"]."  WHERE deleted='$vlr_chkbx_no'  :crt_bsq  ORDER BY orden  LIMIT $prm_lmt  OFFSET $prm_off ;");
	if($stmt2===false){
		trigger_error($db_pdo->error, E_USER_ERROR);
	}
	//Bind params
  ...
  <div id="data_header">
    <table width="100%" align="center" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="10%" align="left"	 valign="middle"><b><?php echo(html_encode("")); ?></b></td>
        <td width="25%" align="left"	 valign="middle"><b><?php echo(html_encode("Descripción")); ?></b></td>
        <td width="45%" align="left"	 valign="middle"><b><?php echo(html_encode("URL Direccionamiento")); ?></b></td>
  ...
  <div id="data_body">
    ...
    <tr style="background-color: <?php echo($color); ?>;">
      <td width="05%" align="center" height="100"><div id="activ_<?php echo($main_data["id_".$_SESSION["elemento"]]); ?>" class="btn_mat_right"><img id="img_mat_right" src="admin/images/mat_icons/<?php echo($sta_icon); ?>" onclick="swtch_activ(<?php echo("'".$_SESSION["elemento"]."', ".$main_data["id_".$_SESSION["elemento"]].", 'shown', ".$main_data["shown"]) ?>)" width="30" height="30" style="margin-top: 4px;" title="<?php echo(html_encode($_SESSION["titulo"]." $sta_text")); ?>" /></div></td>
      <td width="10%" align="left"	 valign="middle"><img src="<?php echo($im_pth); ?>" width="75" height="90" alt="img" style="" /></td>
      <td width="25%" align="left"	 valign="middle"><?php echo(html_encode($main_data["descripcion"])); ?></td>
      <td width="45%" align="left"	 valign="middle"><?php echo(html_encode($main_data["link_url"])); ?></td>
      <td width="05%" align="center" valign="middle"><?php echo($main_data["orden"]); ?></td>
