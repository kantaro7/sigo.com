...
if($ok_ssn){
	...
	$_SESSION["rprog"]			="sr_servic_2";
	$_SESSION["rimag"]			="sr_servic_2";
	$_SESSION["modulo"]			="5";
	$_SESSION["opcion"]			="3";
	
	$_SESSION["tabla"]			="sr_servic_2";
	$_SESSION["elemento"]		="sr_servic_2";
	$_SESSION["titulo"]			="Contenido de Servicio 2";
	$_SESSION["titulos"]		="Contenidos de Servicio 2";
