...
if($reg_tot>0){
	...
	$stmt2=$db_pdo->prepare("SELECT *  FROM ".$_SESSION["tabla"]."  WHERE deleted='$vlr_chkbx_no'  :crt_bsq  ORDER BY id_pp_market DESC  LIMIT $prm_lmt  OFFSET $prm_off ;");
	if($stmt2===false){
		trigger_error($db_pdo->error, E_USER_ERROR);
	}
	//Bind params
  ...
  <div id="data_header">
    <table width="100%" align="center" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="20%" align="left"	 valign="middle"><b><?php echo(html_encode("Título")); ?></b></td>
        <td width="45%" align="left"	 valign="middle"><b><?php echo(html_encode("Texto")); ?></b></td>
        <td width="05%" align="center" valign="middle"><b><?php echo(html_encode("")); ?></b></td>
        <td width="05%"></td>
        <td width="05%"></td></tr>
      <tr>
  ...
  <div id="data_body">
    ...
    <tr style="background-color: <?php echo($color); ?>;">
      ...
      <td width="15%" align="left"	 valign="middle"><img src="<?php echo($im_pth); ?>" width="120" height="80" alt="img" style="" /></td>
      <td width="20%" align="left"	 valign="middle"><?php echo(html_encode($main_data["titulo"])); ?></td>
      <td width="45%" align="left"	 valign="middle"><?php echo(html_encode($main_data["texto"])); ?></td>
      <td width="05%" align="center" valign="middle"></td>
