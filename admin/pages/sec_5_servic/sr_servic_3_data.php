...
if($reg_tot>0){
	...
	$stmt2=$db_pdo->prepare("SELECT *  FROM ".$_SESSION["tabla"]."  WHERE deleted='$vlr_chkbx_no'  :crt_bsq  ORDER BY :crt_ord  LIMIT $prm_lmt  OFFSET $prm_off ;");
	if($stmt2===false){
		trigger_error($db_pdo->error, E_USER_ERROR);
	}
	//Bind params
	$stmt2->bindParam(':crt_bsq', $_SESSION["crt_bsq"], PDO::PARAM_STR);
	$stmt2->bindParam(':crt_ord', $_SESSION["crt_ord"], PDO::PARAM_STR);
	$stmt2->execute();		
	if($status===false){
  ...
  <div id="data_header">
    <table width="100%" align="center" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="20%" align="left"	 valign="middle"><b><?php echo(html_encode("")); ?></b></td>
        <td width="55%" align="left"	 valign="middle"><b><?php echo(html_encode("Descripción")); ?></b></td>
        <td width="05%" align="center" valign="middle"><b><?php echo(html_encode("Fila Nro")); ?></b></td>
  ...
  <div id="data_body">
    ...
    $im_sze=60;
    if($main_data["tamano"]=="$vlr_chkbx_si") $im_sze=120;
		?>
    <tr style="background-color: <?php echo($color); ?>;">
      ...
      <td width="20%" align="left"	 valign="middle"><img src="<?php echo($im_pth); ?>" width="<?php echo($im_sze); ?>" height="60" alt="img" style="" /></td>
      <td width="55%" align="left"	 valign="middle"><?php echo(html_encode($main_data["descripcion"])); ?></td>
      <td width="05%" align="center" valign="middle"><?php echo(html_encode($main_data["fila"])); ?></td>
