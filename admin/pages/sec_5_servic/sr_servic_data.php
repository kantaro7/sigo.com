...
if($reg_tot>0){
  ...
  <div id="data_header">
    <table width="100%" align="center" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="25%" align="left"	 valign="middle"><b><?php echo(html_encode("Nombre")); ?></b></td>
        <td width="45%" align="left"	 valign="middle"><b><?php echo(html_encode("Texto de Card")); ?></b></td>
  ...
  <div id="data_body">
    ...
    $im_pth="admin/upld_".$_SESSION["rimag"]."/ft_1_".$main_data["id_".$_SESSION["elemento"]].".".str_replace(".", "", substr($main_data["name_foto_1"], -4))."?vrbl=".$random;
		?>
    <tr style="background-color: <?php echo($color); ?>;">
      ...
      <td width="10%" align="left"	 valign="middle"><img src="<?php echo($im_pth); ?>" width="80" height="80" alt="img" style="" /></td>
      <td width="25%" align="left"	 valign="middle"><?php echo(html_encode($main_data["nombre"])); ?></td>
      <td width="45%" align="left"	 valign="middle"><?php echo(html_encode($main_data["texto_1"])); ?></td>
