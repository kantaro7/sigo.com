...
$tmn_ico="check_un1_36.png";
if($reg_data["tamano"]=="$vlr_chkbx_si") $tmn_ico="check1_36.png";
?>
...
<div id="actual_contenedor">
  ...
  <div>
    <form id="frm_actual" name="frm_actual" method="post" action="<?php echo("admin/pages/".$_SESSION["carpeta"]."/".$_SESSION["rprog"]."_actual_db.php"); ?>" onsubmit="return frm_vldt_<?php echo($_SESSION["rprog"]."('$accn');"); ?>" enctype="multipart/form-data" accept-charset="UTF-8">
        ...
        <div id="elmnt_title"><?php echo(html_encode("Descripción")); ?></div>
        <div id="elmnt_case">
        	<input type="text" name="descripcion" id="descripcion" class="elmnt_elmnt" size="70" maxlength="150" placeholder="<?php echo(html_encode("Indique la descripción")); ?>" value="<?php echo(html_encode($reg_data["descripcion"])); ?>" tabindex="01" onKeyPress="if(event.keyCode==13){ document.getElementById('fila').focus(); } return frmt_alpha(event);" >
        </div>
			</div>
			<div id="elmnt_block">
        <div id="elmnt_image"><img id="img_mat_right" src="admin/images/mat_icons/fila_36.png" width="30" height="30" style=" float: left; margin-top: 3px; margin-left: 3px;" /></div>
        <div id="elmnt_title"><?php echo(html_encode("Fila Nro")); ?></div>
        <div id="elmnt_case">
        	<input type="text" name="fila" id="fila" class="elmnt_elmnt" size="50" maxlength="3" placeholder="<?php echo(html_encode("Indique la fila")); ?>" value="<?php echo($reg_data["fila"]); ?>" tabindex="01" onKeyPress="if(event.keyCode==13){ document.getElementById('orden').focus(); } return frmt_nmbr_int(event);" >
        </div>
			</div>
			<div id="elmnt_block">
        ...
        <input name="act_chk" id="act_chk" type="checkbox" value="<?php echo($vlr_chkbx_si); ?>" <?php if($reg_data["shown"]=="$vlr_chkbx_si") echo(" checked "); ?> style="display: none;" />
 			...
 			<div id="elmnt_block">
        <div id="elmnt_image"><img id="img_mat_right" src="admin/images/mat_icons/double_36.png" width="30" height="30" style=" float: left; margin-top: 3px; margin-left: 3px;" /></div>
        <div id="elmnt_title"><?php echo(html_encode("Ancho Doble?")); ?></div>
				<img id="tmn_ico" class="elmnt_ic_chk" src="admin/images/mat_icons/<?php echo($tmn_ico); ?>" onclick="swtch_chkbox(this.id, 'tmn_chk');" alt="" width="34" height="34" />
        <input name="tmn_chk" id="tmn_chk" type="checkbox" value="<?php echo($vlr_chkbx_si); ?>" <?php if($reg_data["tamano"]=="$vlr_chkbx_si") echo(" checked "); ?> style="display: none;" />
			</div>     
 			<div id="elmnt_block">
        ...
        <div id="elmnt_case_sl">
          <div class="elmnt_foto"><input type="file" name="img_foto" id="img_foto" class="elmnt_file" size="2" maxlength="150" style="float: left;" ></div>
      		<div class="msg_image"><?php echo(html_encode("(Dimensiones: 600 (o 1200) x 600 pixeles. Peso no mayor de 500 Kb. Tipo JPG o PNG.)")); ?></div>
        </div>
			</div>
