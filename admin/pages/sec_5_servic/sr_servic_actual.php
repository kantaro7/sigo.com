...
<div id="actual_contenedor">
  ...
  <div>
    <form id="frm_actual" name="frm_actual" method="post" action="<?php echo("admin/pages/".$_SESSION["carpeta"]."/".$_SESSION["rprog"]."_actual_db.php"); ?>" onsubmit="return frm_vldt_<?php echo($_SESSION["rprog"]."('$accn');"); ?>" enctype="multipart/form-data" accept-charset="UTF-8">
        ...
        <div id="elmnt_case">
					<textarea name="nombre" id="nombre" cols="58" rows="1" class="elmnt_elmnt" placeholder="<?php echo(html_encode("Indique el nombre")); ?>" style="color: #444444; font-family: Calibri, Arial font-size: 18px; font-weight: 300; line-height: 22px;" onKeyPress="return frmt_alpha(event);" ><?php echo(html_encode($reg_data["nombre"])); ?></textarea>
        </div>
			</div>
			<div id="elmnt_block">
        <div id="elmnt_image"><img id="img_mat_right" src="admin/images/mat_icons/label_36.png" width="30" height="30" style=" float: left; margin-top: 3px; margin-left: 3px;" /></div>
        <div id="elmnt_title"><?php echo(html_encode("Texto de Card")); ?></div>
        <div id="elmnt_case">
					<textarea name="texto_1" id="texto_1" cols="58" rows="3" class="elmnt_elmnt" placeholder="<?php echo(html_encode("Indique el Texto")); ?>" style="color: #444444; font-family: Calibri, Arial font-size: 18px; font-weight: 300; line-height: 22px;" onKeyPress="return frmt_alpha(event);" ><?php echo(html_encode($reg_data["texto_1"])); ?></textarea>
        </div>
			</div>
			<div id="elmnt_block">
        ...
        <div id="elmnt_title"><?php echo(html_encode("URL de Redireccionamiento")); ?></div>
        <div id="elmnt_case">
        	<input type="text" name="link_url" id="link_url" class="elmnt_elmnt" size="70" maxlength="150" placeholder="<?php echo(html_encode("Indique el URL de Redireccionamiento")); ?>" value="<?php echo(html_encode($reg_data["link_url"])); ?>" tabindex="01" onKeyPress="if(event.keyCode==13){ document.getElementById('orden').focus(); } return frmt_alpha(event);" >
        </div>
			</div>
			<div id="elmnt_block">
        ...
        <div id="elmnt_title"><?php echo(html_encode("Imagen de Card")); ?></div>
        <div id="elmnt_case_sl">
          <div class="elmnt_foto"><input type="file" name="img_foto_1" id="img_foto_1" class="elmnt_file" size="2" maxlength="150" style="float: left;" ></div>
      		<div class="msg_image"><?php echo(html_encode("(Dimensiones: 300 x 300 pixeles. Peso no mayor de 50 Kb. Tipo JPG o PNG.)")); ?></div>
        </div>
        <div id="elmnt_title"><?php echo(html_encode("Imagen de Banner Superior Interno")); ?></div>
        <div id="elmnt_case_sl">
          <div class="elmnt_foto"><input type="file" name="img_foto_2" id="img_foto_2" class="elmnt_file" size="2" maxlength="150" style="float: left;" ></div>
      		<div class="msg_image"><?php echo(html_encode("(Dimensiones: 1360 x 530 pixeles. Peso no mayor de 500 Kb. Tipo JPG o PNG.)")); ?></div>
        </div>
			</div>
			<div id="elmnt_block">
        <div id="elmnt_image"><img id="img_mat_right" src="admin/images/mat_icons/label_36.png" width="30" height="30" style=" float: left; margin-top: 3px; margin-left: 3px;" /></div>
        <div id="elmnt_title"><?php echo(html_encode("Texto de Contenido Interno")); ?></div>
        <div id="elmnt_case">
					<textarea name="texto_2" id="texto_2" cols="58" rows="5" class="elmnt_elmnt" placeholder="<?php echo(html_encode("Indique el Texto")); ?>" style="color: #444444; font-family: Calibri, Arial font-size: 18px; font-weight: 300; line-height: 22px;" onKeyPress="return frmt_alpha(event);" ><?php echo(html_encode($reg_data["texto_2"])); ?></textarea>
        </div>
			</div>
