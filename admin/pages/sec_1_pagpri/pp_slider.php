...
if($ok_ssn){
	...
	$_SESSION["rprog"]			="pp_slider";
	$_SESSION["rimag"]			="pp_slider";
	$_SESSION["modulo"]			="1";
	$_SESSION["opcion"]			="1";
	
	$_SESSION["tabla"]			="pp_slider";
	$_SESSION["elemento"]		="pp_slider";
	$_SESSION["titulo"]			="Imagen de Slider Superior";
	$_SESSION["titulos"]		="Imágenes de Slider Superior";
