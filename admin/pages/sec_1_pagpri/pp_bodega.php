...
if($ok_ssn){
	...
	$_SESSION["rprog"]			="pp_bodega";
	$_SESSION["rimag"]			="pp_bodega";
	$_SESSION["modulo"]			="1";
	$_SESSION["opcion"]			="3";
	
	$_SESSION["tabla"]			="pp_bodega";
	$_SESSION["elemento"]		="pp_bodega";
	$_SESSION["titulo"]			="Contenido de la Sección Bodegón";
	$_SESSION["titulos"]		="Contenidos de la Sección Bodegón";
	...
	$_SESSION["crt_bsq"]="";
	$_SESSION["crt_tit"]="";
	$_SESSION["crt_ord"]="id_pp_bodega DESC";
	?>
  <style type="text/css">
		#gran_contenedor {
			width: 100%;
