...
if($ok_ssn){
	...
	$_SESSION["carpeta"]		="sec_2_nosotr";
	$_SESSION["rprog"]			="ns_prirec";
	$_SESSION["rimag"]			="ns_prirec";
	$_SESSION["modulo"]			="2";
	$_SESSION["opcion"]			="2";
	
	$_SESSION["tabla"]			="ns_prirec";
	$_SESSION["elemento"]		="ns_prirec";
	$_SESSION["titulo"]			="Contenido de la Sección Principios Rectores";
	$_SESSION["titulos"]		="Contenidos de la Sección Principios Rectores";
	$_SESSION["letra_final"]="o";
	...
	$_SESSION["crt_bsq"]="";
	$_SESSION["crt_tit"]="";
	$_SESSION["crt_ord"]="id_ns_prirec DESC";
	?>
  <style type="text/css">
		#gran_contenedor {
			width: 100%;
