...
if($reg_tot>0){
	...
	$stmt2=$db_pdo->prepare("SELECT *, case programa  when 1 then 'Programas de RSE Internos'  when 2 then 'RSE con nuestras comunidades'  end as nom_programa  FROM ".$_SESSION["tabla"]."  WHERE deleted='$vlr_chkbx_no'  :crt_bsq  ORDER BY :crt_ord  LIMIT $prm_lmt  OFFSET $prm_off ;");
	if($stmt2===false){
		trigger_error($db_pdo->error, E_USER_ERROR);
	}
	//Bind params
  ...
  <div id="data_header">
    <table width="100%" align="center" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="30%" align="left"	 valign="middle"><b><?php echo(html_encode("Programa")); ?></b></td>
  ...
  <div id="data_body">
    ...
    <tr style="background-color: <?php echo($color); ?>;">
      ...
      <td width="30%" align="left"	 valign="middle"><?php echo(html_encode($main_data["nom_programa"])); ?></td>
